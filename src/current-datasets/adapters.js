...
const adapters = {
  "pokemon-identity-mappings": {
    ...
    compactCurrent: true,
    generatorKey: "pokemon-identity-mappings",
    generatorOptions: identityGeneratorOptions,
    jsonPath: "data/reference/game-master/gameMasterPokemonMappings.json",
  ...
  "best-attackers": {
    ...
    compactCurrent: true,
    compressData: true,
    generatorKey: "best-attackers",
    jsonPath: "data/rankings/pve/attackers.json",
  ...
  "best-defenders": {
    ...
    compactCurrent: true,
    compressData: true,
    generatorKey: "best-defenders",
    generatorOptions: identityGeneratorOptions,
    jsonPath: "data/rankings/pve/defenders.json",
  ...
  "costume-audit": {
    ...
    compactCurrent: true,
    compressData: true,
    generatorKey: "costume-audit",
    generatorOptions: identityGeneratorOptions,
    jsonPath: "operations/audits/costume/current.json",
  ...
  "pvp-rankings": {
    ...
    generatorKey: "pvp-rankings",
    generatorOptions: pvpIdentityGeneratorOptions,
    jsonPath: "data/pvp/rankings/current.json",
  ...
  "gbl-calendar": {
    ...
    Model: GblCalendar,
    compactCurrent: true,
    generatorKey: "gbl-calendar",
    jsonPath: "data/battles/gbl/calendar.json",
  ...
  raids: {
    ...
    generatorKey: "raids",
    generatorOptions: identityGeneratorOptions,
    jsonPath: "data/battles/raids/current.json",
  ...
  eggs: {
    ...
    generatorKey: "eggs",
    generatorOptions: identityGeneratorOptions,
    jsonPath: "data/activities/eggs/current.json",
  ...
  "max-battles": {
    ...
    Model: MaxBattle,
    generatorKey: "max-battles",
    generatorOptions: identityGeneratorOptions,
    jsonPath: "data/battles/max-battles/current.json",
  ...
  research: {
    ...
    Model: Research,
    generatorKey: "research",
    generatorOptions: identityGeneratorOptions,
    jsonPath: "data/activities/research/current.json",
  ...
  rocket: {
    ...
    generatorKey: "rocket",
    generatorOptions: identityGeneratorOptions,
    jsonPath: "data/battles/rocket/current.json",
